...
export const LANGS = ["en", "th", "ru", "zh", "de", "no"];

export const LANG_LABELS = { en: "English", th: "ไทย", ru: "Русский", zh: "中文", de: "Deutsch", no: "Norsk" };
...
export const AREAS = [
  { id: "hua-hin", label: { en: "Hua Hin", th: "หัวหิน", ru: "Хуахин", zh: "华欣", de: "Hua Hin", no: "Hua Hin" } },
  { id: "pranburi", label: { en: "Pranburi", th: "ปราณบุรี", ru: "Пранбури", zh: "巴蓝武里", de: "Pranburi", no: "Pranburi" } },
  { id: "cha-am", label: { en: "Cha-am", th: "ชะอำ", ru: "Ча-Ам", zh: "差安", de: "Cha-am", no: "Cha-am" } },
];

export const TYPES = [
  { id: "villa", label: { en: "Pool Villa", th: "พูลวิลล่า", ru: "Вилла с бассейном", zh: "泳池别墅", de: "Poolvilla", no: "Bassengvilla" } },
  { id: "house", label: { en: "House", th: "บ้านเดี่ยว", ru: "Дом", zh: "独立屋", de: "Haus", no: "Hus" } },
  { id: "condo", label: { en: "Condo", th: "คอนโด", ru: "Кондо", zh: "公寓", de: "Eigentumswohnung", no: "Leilighet" } },
  { id: "land", label: { en: "Land", th: "ที่ดิน", ru: "Земля", zh: "土地", de: "Grundstück", no: "Tomt" } },
  { id: "commercial", label: { en: "Commercial", th: "เชิงพาณิชย์", ru: "Коммерция", zh: "商业地产", de: "Gewerbe", no: "Næringseiendom" } },
];

export const STATUS = {
  sale: { en: "For Sale", th: "ประกาศขาย", ru: "Продаётся", zh: "出售", de: "Zu verkaufen", no: "Til salgs" },
  rent: { en: "For Rent", th: "ประกาศเช่า", ru: "В аренду", zh: "出租", de: "Zu vermieten", no: "Til leie" },
  rented: { en: "Rented", th: "เช่าแล้ว", ru: "Сдано в аренду", zh: "已出租", de: "Vermietet", no: "Utleid" },
  sold: { en: "Sold", th: "ขายแล้ว", ru: "Продано", zh: "已售", de: "Verkauft", no: "Solgt" },
  reserved: { en: "Reserved", th: "จองแล้ว", ru: "Забронировано", zh: "已预订", de: "Reserviert", no: "Reservert" },
};

export const FEATURES = {
  sea_view: { en: "Sea View", th: "วิวทะเล", ru: "Вид на море", zh: "海景", de: "Meerblick", no: "Sjøutsikt" },
  mountain_view: { en: "Mountain View", th: "วิวภูเขา", ru: "Вид на горы", zh: "山景", de: "Bergblick", no: "Fjellutsikt" },
  pool: { en: "Private Pool", th: "สระว่ายน้ำส่วนตัว", ru: "Частный бассейн", zh: "私人泳池", de: "Privater Pool", no: "Privat basseng" },
  shared_pool: { en: "Shared Pool", th: "สระว่ายน้ำส่วนกลาง", ru: "Общий бассейн", zh: "共用泳池", de: "Gemeinschaftspool", no: "Fellesbasseng" },
  furnished: { en: "Fully Furnished", th: "เฟอร์นิเจอร์ครบ", ru: "С мебелью", zh: "全套家具", de: "Voll möbliert", no: "Fullt møblert" },
  new: { en: "New / Move-in Ready", th: "บ้านใหม่ พร้อมเข้าอยู่", ru: "Новый, готов к заселению", zh: "全新可入住", de: "Neu / Bezugsfertig", no: "Nytt / Innflytningsklart" },
  beachfront: { en: "Beachfront", th: "ติดชายหาด", ru: "На берегу моря", zh: "海滨第一排", de: "Direkt am Strand", no: "Ved stranden" },
  gated: { en: "Gated Village", th: "หมู่บ้านมีระบบรักษาความปลอดภัย", ru: "Закрытый посёлок", zh: "封闭式社区", de: "Bewachte Siedlung", no: "Gjerdet boligområde" },
  quiet: { en: "Quiet Soi", th: "ซอยเงียบสงบ", ru: "Тихая улица", zh: "安静巷弄", de: "Ruhige Straße", no: "Rolig gate" },
  golf: { en: "Near Golf Course", th: "ใกล้สนามกอล์ฟ", ru: "Рядом с полем для гольфа", zh: "近高尔夫球场", de: "Nahe Golfplatz", no: "Nær golfbane" },
  riverside: { en: "Riverside", th: "ติดริมแม่น้ำ", ru: "У реки", zh: "河畔", de: "Am Fluss", no: "Ved elven" },
  rental_yield: { en: "Strong Rental Yield", th: "ผลตอบแทนค่าเช่าดี", ru: "Высокая доходность аренды", zh: "租金回报高", de: "Hohe Mietrendite", no: "Høy leieavkastning" },
  pet_friendly: { en: "Pet Friendly", th: "เลี้ยงสัตว์ได้", ru: "Можно с животными", zh: "允许宠物", de: "Haustiere erlaubt", no: "Kjæledyr tillatt" },
};
