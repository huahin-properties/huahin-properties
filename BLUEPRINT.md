...
5. **หน้าสมัครสมาชิก Agent/เจ้าของบ้าน + Landing Page มาร์เก็ตติ้ง (AI-powered) + ระยะฟรี "Founding Agents"** ← *ทำต่อจากนี้*
   (ยังไม่มีการเก็บเงินในขั้นนี้ จึงไม่ต้องรอ Stripe)
6. วงจรชีวิตประกาศ & ลบข้อมูล/รูปภาพอัตโนมัติ (หมวด 9)
