...
5. ~~Featured Listing boost~~ ✅ **เสร็จแล้ว** — เจ้าของ/Agent จ่ายเพิ่มดันประกาศขึ้นก่อนใครชั่วคราว (7/30 วัน)
   ...
   ประกาศที่ boost อยู่ให้ขึ้นก่อนเสมอในโซน Featured Properties
   - **ยังไม่ได้ทำ**: badge "🌟 Featured" โชว์บนการ์ดฝั่งสาธารณะ, จัดลำดับ Featured ในหน้า Search Results
     ด้วย (ตอนนี้มีผลแค่หน้า Home), ให้ Agent/เจ้าของบ้านกดซื้อเองจากหน้า Lister Billing (ตอนนี้แอดมินกดให้เท่านั้น)
6. ~~เปิดขายแบนเนอร์ให้ลูกค้าภายนอกจริง~~ ✅ **เสร็จแล้ว** — หน้าสาธารณะ `Advertise.dc.html` ให้ธุรกิจภายนอก
   ...
   ของตัวเองแบบ "รอชำระเงิน" ได้ (แก้ไข/อนุมัติยังเป็นสิทธิ์แอดมินเท่านั้น)
   - **ยังไม่ได้ทำ**: การกรองหมดอายุ (`expiresAt`) ยังใช้แค่ที่ Home หน้าเดียว (Search Results/Property Details
     ยังไม่เช็ค), หน้า Admin ยังไม่มีตัวกรองดู "แบนเนอร์รอชำระเงิน vs จ่ายแล้ว" แยกจากกัน
