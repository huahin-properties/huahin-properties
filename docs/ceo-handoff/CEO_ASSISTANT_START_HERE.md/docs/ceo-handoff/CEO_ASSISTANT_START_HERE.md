...
ไฟล์นี้ (orientation)
`PROJECT_CONTEXT_SNAPSHOT.md` — ภาพรวมโครงการทั้งหมด ณ ปัจจุบัน
`CURRENT_PHASE_STATUS.md` — Phase ปัจจุบัน, สิ่งที่เสร็จ/ยังไม่เสร็จ, Blocker
`PROJECT_OPERATING_STANDARD.md` — กฎการทำงาน, Workflow, Definition of Done
`../../PROJECT_HISTORY.md` — เฉพาะ entry ล่าสุด 3-5 รายการ (ไม่ต้องอ่านทั้งไฟล์)
`../../BLUEPRINT.md` — อ่านเฉพาะหมวดที่เกี่ยวกับงานที่กำลังจะทำ (ไม่ต้องอ่านทั้งไฟล์)
6. ห้ามทำอะไร
