...
เปิดไฟล์ `HANDOVER PROMPT.md` แล้วคัดลอกเนื้อหาทั้งหมดในไฟล์ วางเป็นข้อความแรกในห้องแชตใหม่ที่เพิ่งแนบไฟล์ครบแล้ว (หลังจากทำตามหัวข้อ 3 เสร็จ) จากนั้นกดส่ง
