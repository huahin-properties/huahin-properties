...
export const LANGS = ["en", "th", "ru", "zh"];

export const LANG_LABELS = { en: "English", th: "ไทย", ru: "Русский", zh: "中文" };
...
export const AREAS = [
  { id: "hua-hin", label: { en: "Hua Hin", th: "หัวหิน", ru: "Хуахин", zh: "华欣" } },
  { id: "pranburi", label: { en: "Pranburi", th: "ปราณบุรี", ru: "Пранбури", zh: "巴蓝武里" } },
  { id: "cha-am", label: { en: "Cha-am", th: "ชะอำ", ru: "Ча-Ам", zh: "差安" } },
];

export const TYPES = [
  { id: "villa", label: { en: "Pool Villa", th: "พูลวิลล่า", ru: "Вилла с бассейном", zh: "泳池别墅" } },
  { id: "house", label: { en: "House", th: "บ้านเดี่ยว", ru: "Дом", zh: "独立屋" } },
  { id: "condo", label: { en: "Condo", th: "คอนโด", ru: "Кондо", zh: "公寓" } },
  { id: "land", label: { en: "Land", th: "ที่ดิน", ru: "Земля", zh: "土地" } },
  { id: "commercial", label: { en: "Commercial", th: "เชิงพาณิชย์", ru: "Коммерция", zh: "商业地产" } },
];

export const STATUS = {
  sale: { en: "For Sale", th: "ประกาศขาย", ru: "Продаётся", zh: "出售" },
  rent: { en: "For Rent", th: "ประกาศเช่า", ru: "В аренду", zh: "出租" },
  rented: { en: "Rented", th: "เช่าแล้ว", ru: "Сдано в аренду", zh: "已出租" },
  sold: { en: "Sold", th: "ขายแล้ว", ru: "Продано", zh: "已售" },
  reserved: { en: "Reserved", th: "จองแล้ว", ru: "Забронировано", zh: "已预订" },
};

export const FEATURES = {
  sea_view: { en: "Sea View", th: "วิวทะเล", ru: "Вид на море", zh: "海景" },
  mountain_view: { en: "Mountain View", th: "วิวภูเขา", ru: "Вид на горы", zh: "山景" },
  pool: { en: "Private Pool", th: "สระว่ายน้ำส่วนตัว", ru: "Частный бассейн", zh: "私人泳池" },
  shared_pool: { en: "Shared Pool", th: "สระว่ายน้ำส่วนกลาง", ru: "Общий бассейн", zh: "共用泳池" },
  furnished: { en: "Fully Furnished", th: "เฟอร์นิเจอร์ครบ", ru: "С мебелью", zh: "全套家具" },
  new: { en: "New / Move-in Ready", th: "บ้านใหม่ พร้อมเข้าอยู่", ru: "Новый, готов к заселению", zh: "全新可入住" },
  beachfront: { en: "Beachfront", th: "ติดชายหาด", ru: "На берегу моря", zh: "海滨第一排" },
  gated: { en: "Gated Village", th: "หมู่บ้านมีระบบรักษาความปลอดภัย", ru: "Закрытый посёлок", zh: "封闭式社区" },
  quiet: { en: "Quiet Soi", th: "ซอยเงียบสงบ", ru: "Тихая улица", zh: "安静巷弄" },
  golf: { en: "Near Golf Course", th: "ใกล้สนามกอล์ฟ", ru: "Рядом с полем для гольфа", zh: "近高尔夫球场" },
  riverside: { en: "Riverside", th: "ติดริมแม่น้ำ", ru: "У реки", zh: "河畔" },
  rental_yield: { en: "Strong Rental Yield", th: "ผลตอบแทนค่าเช่าดี", ru: "Высокая доходность аренды", zh: "租金回报高" },
  pet_friendly: { en: "Pet Friendly", th: "เลี้ยงสัตว์ได้", ru: "Можно с животными", zh: "允许宠物" },
};
...
export const PROPERTIES = [
  {
    ...
    title: { en: "Sunset Cliff Pool Villa", th: "พูลวิลล่าซันเซ็ทคลิฟ เขาเต่า", ru: "Вилла с бассейном Sunset Cliff", zh: "日落崖泳池别墅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Black Mountain Garden House", th: "บ้านสวนแบล็คเมาน์เทน หินเหล็กไฟ", ru: "Дом с садом Black Mountain", zh: "黑山花园别墅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Marina Bay Seaview Condo", th: "คอนโดวิวทะเล มารีน่า เบย์", ru: "Кондо с видом на море Marina Bay", zh: "海景公寓 Marina Bay" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Dolphin Bay Beachfront Villa", th: "วิลล่าติดหาดดอลฟินเบย์", ru: "Пляжная вилла Dolphin Bay", zh: "海豚湾海滨别墅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Pranburi Forest Pool Villa", th: "พูลวิลล่าป่าปราณบุรี ปากน้ำปราณ", ru: "Вилла с бассейном Pranburi Forest", zh: "巴蓝武里森林泳池别墅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Pranburi Riverside Land Plot", th: "ที่ดินริมแม่น้ำปราณบุรี วังก์พง", ru: "Земельный участок у реки Pranburi", zh: "巴蓝武里河畔地块" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Cha-am Beachwalk Condo", th: "คอนโดชะอำ บีชวอล์ค", ru: "Кондо Cha-am Beachwalk", zh: "差安海滨步道公寓" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Green Valley Pool Villa", th: "พูลวิลล่ากรีนวัลเลย์ หนองแก", ru: "Вилла с бассейном Green Valley", zh: "绿谷泳池别墅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Cha-am Golf Course House", th: "บ้านเช่าวิวกอล์ฟ ชะอำฮิลไซด์", ru: "Дом у гольф-поля Cha-am", zh: "差安高尔夫景观住宅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Hillside Sunset Villa", th: "วิลล่าเนินเขาซันเซ็ท หินเหล็กไฟ", ru: "Вилла Hillside Sunset", zh: "山丘日落别墅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Sam Roi Yot Mountain View Land", th: "ที่ดินวิวเขาสามร้อยยอด", ru: "Земля с видом на гору Sam Roi Yot", zh: "三百峰山景地块" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Cha-am Seabreeze Townhome", th: "ทาวน์โฮมชะอำ ซีบรีซ", ru: "Таунхаус Cha-am Seabreeze", zh: "差安海风联排别墅" },
    shortDesc: {
  ...
  },
  {
    ...
    title: { en: "Thap Tai Garden House", th: "บ้านสวนทับใต้", ru: "Дом с садом Thap Tai", zh: "塔拜花园住宅" },
    shortDesc: { en: "A tidy 3-bedroom family house on a quiet Thap Tai soi.", th: "บ้านครอบครัว 3 ห้องนอน เรียบร้อย ในซอยเงียบย่านทับใต้", ru: "Аккуратный семейный дом на 3 спальни на тихой улице Thap Tai.", zh: "位于塔拜安静巷弄内的整洁三卧室家庭住宅。" },
    fullDesc: { en: "Recently repainted single-storey house on a quiet residential soi, five minutes from Hua Hin's Bluport shopping centre.", th: "บ้านชั้นเดียวทาสีใหม่ ในซอยที่พักอาศัยเงียบสงบ ห่างศูนย์การค้าบลูพอร์ตหัวหินเพียง 5 นาที", ru: "Недавно перекрашенный одноэтажный дом на тихой жилой улице, в пяти минутах от торгового центра Bluport в Хуахине.", zh: "近期重新粉刷的平房，位于安静住宅巷内，距华欣蓝湾购物中心仅5分钟车程。" },
  ...
  },
  {
    ...
    title: { en: "Soi 88 City Condo", th: "คอนโดซอย 88", ru: "Кондо Soi 88", zh: "88巷城市公寓" },
    shortDesc: { en: "A compact furnished 1-bedroom condo close to Hua Hin's night market.", th: "คอนโด 1 ห้องนอน เฟอร์นิเจอร์ครบ ใกล้ตลาดโต้รุ่งหัวหิน", ru: "Компактное меблированное кондо на 1 спальню рядом с ночным рынком Хуахина.", zh: "紧凑型精装一卧室公寓，靠近华欣夜市。" },
    fullDesc: { en: "Ground-up 2025 development a short walk from Hua Hin's Chatchai night market, with a rooftop pool and 24-hour security.", th: "โครงการสร้างใหม่ปี 2568 เดินไม่ไกลจากตลาดโต้รุ่งฉัตรชัยหัวหิน มีสระว่ายน้ำดาดฟ้าและรักษาความปลอดภัยตลอด 24 ชั่วโมง", ru: "Новостройка 2025 года в нескольких минутах ходьбы от ночного рынка Chatchai в Хуахине, с бассейном на крыше и круглосуточной охраной.", zh: "2025年全新开发项目，步行即达华欣察差夜市，设有屋顶泳池及24小时保安。" },
  ...
  },
  {
    ...
    title: { en: "Hin Lek Fai Golf-View Land", th: "ที่ดินวิวกอล์ฟ หินเหล็กไฟ", ru: "Земля с видом на гольф Hin Lek Fai", zh: "欣勒法伊高尔夫景观地块" },
    shortDesc: { en: "1,600 sqm of flat land facing Black Mountain Golf Club, ready to build.", th: "ที่ดินราบเรียบ 1,600 ตร.ว. หันหน้าสนามกอล์ฟแบล็คเมาน์เทน พร้อมปลูกสร้าง", ru: "Ровный участок 1600 кв.м с видом на гольф-клуб Black Mountain, готов к застройке.", zh: "1600平方米平整地块，面向黑山高尔夫球会，具备建屋条件。" },
    fullDesc: { en: "A cleared, level plot bordering Black Mountain Golf Club's back nine, with road frontage and utilities already connected.", th: "ที่ดินเคลียร์พร้อมใช้งาน ติดขอบสนามกอล์ฟแบล็คเมาน์เทนฝั่งหลุมท้าย มีถนนติดแนวเขตและระบบสาธารณูปโภคพร้อม", ru: "Расчищенный ровный участок на границе задней девятки гольф-клуба Black Mountain, с подъездной дорогой и подключёнными коммуникациями.", zh: "已清理平整地块，毗邻黑山高尔夫球会后九洞，临街道且水电已通。" },
  ...
  },
  {
    ...
    title: { en: "Hua Hin Town Shophouse", th: "ตึกแถวใจกลางเมืองหัวหิน", ru: "Коммерческое здание в центре Хуахина", zh: "华欣市中心商铺" },
  ...
  },
  {
    ...
    title: { en: "Pranburi Forest Estate Villa", th: "วิลล่าเอสเตทป่าปราณบุรี", ru: "Вилла Pranburi Forest Estate", zh: "巴蓝武里森林庄园别墅" },
    shortDesc: { en: "A gated 4-bedroom pool villa estate bordering Pranburi Forest Park.", th: "วิลล่าพูล 4 ห้องนอน ในโครงการรั้วรอบขอบชิด ติดอุทยานป่าปราณบุรี", ru: "Вилла с бассейном на 4 спальни в закрытом посёлке у парка Pranburi Forest.", zh: "四卧室泳池别墅庄园，毗邻巴蓝武里森林公园，位于封闭社区内。" },
    fullDesc: { en: "Set within a small gated estate bordering Pranburi Forest Park, this villa pairs a 14-metre pool with a double-height living pavilion and staff quarters.", th: "ตั้งอยู่ในโครงการรั้วรอบขอบชิดขนาดเล็กติดอุทยานป่าปราณบุรี วิลล่าหลังนี้มาพร้อมสระว่ายน้ำยาว 14 เมตร ห้องนั่งเล่นเพดานสูง และห้องพักพนักงาน", ru: "Расположенная в небольшом закрытом комплексе у парка Pranburi Forest, эта вилла сочетает бассейн 14 метров с гостиной двойной высоты и жильём для персонала.", zh: "别墅位于毗邻巴蓃武里森林公园的小型封闭庄园内，配备14米泳池、挑高客厅及员工宿舍。" },
  ...
  },
  {
    ...
    title: { en: "Pak Nam Pran Beachside Cottage", th: "บ้านเช่าริมหาดปากน้ำปราณ", ru: "Пляжный коттедж Pak Nam Pran", zh: "巴南浦兰海滨小屋" },
    shortDesc: { en: "A furnished 2-bedroom cottage for rent, 1km from Pak Nam Pran beach.", th: "บ้านเช่า 2 ห้องนอน เฟอร์นิเจอร์ครบ ห่างหาดปากน้ำปราณ 1 กม.", ru: "Меблированный коттедж на 2 спальни в аренду, в 1 км от пляжа Pak Nam Pran.", zh: "两卧室精装小屋出租，距巴南浦兰海滩仅1公里。" },
    fullDesc: { en: "Single-storey rental cottage in a quiet fishing village setting, an easy bicycle ride to Pak Nam Pran's beach cafes.", th: "บ้านเช่าชั้นเดียว บรรยากาศหมู่บ้านชาวประมงเงียบสงบ ปั่นจักรยานไม่ไกลถึงร้านกาแฟริมหาดปากน้ำปราณ", ru: "Одноэтажный арендный коттедж в тихой рыбацкой деревне, легко доехать на велосипеде до пляжных кафе Pak Nam Pran.", zh: "位于宁静渔村的平房出租屋，骑自行车即可轻松抵达巴南浦兰海滩咖啡馆。" },
  ...
  },
  {
    ...
    title: { en: "Nong Chumsaeng Riverside Land", th: "ที่ดินริมน้ำหนองจำแสง", ru: "Земля у реки Nong Chumsaeng", zh: "农仲森河畔地块" },
  ...
  },
  {
    ...
    title: { en: "Cha-am Hillside Family House", th: "บ้านครอบครัวเนินเขาชะอำ", ru: "Семейный дом Cha-am Hillside", zh: "差安山丘家庭住宅" },
    shortDesc: { en: "A 3-bedroom family house near Cha-am's golf courses, quiet and low-maintenance.", th: "บ้านครอบครัว 3 ห้องนอน ใกล้สนามกอล์ฟชะอำ เงียบสงบ ดูแลง่าย", ru: "Семейный дом на 3 спальни рядом с полями для гольфа Cha-am, тихий и простой в обслуживании.", zh: "三卧室家庭住宅，靠近差安高尔夫球场，安静且易于打理。" },
    fullDesc: { en: "A low-maintenance single-storey house in a mature neighbourhood near Cha-am's golf courses, with a small covered carport and fenced yard.", th: "บ้านชั้นเดียวดูแลง่าย ในย่านที่พักอาศัยที่ลงตัว ใกล้สนามกอล์ฟชะอำ มีที่จอดรถมีหลังคาขนาดเล็กและสนามหญ้ารั้วรอบ", ru: "Простой в обслуживании одноэтажный дом в сложившемся районе рядом с полями для гольфа Cha-am, с небольшим крытым навесом и огороженным двором.", zh: "位于成熟社区的易打理平房，靠近差安高尔夫球场，配有小型有顶车位及围栏庭院。" },
  ...
  },
  {
    ...
    title: { en: "Cha-am Beachfront Pool Villa", th: "พูลวิลล่าติดหาดชะอำ", ru: "Пляжная вилла с бассейном Cha-am", zh: "差安海滨泳池别墅" },
    shortDesc: { en: "A 3-bedroom pool villa for rent, 400m from Cha-am beach with sea glimpses.", th: "พูลวิลล่า 3 ห้องนอน ให้เช่า ห่างหาดชะอำ 400 เมตร เห็นวิวทะเล", ru: "Вилла с бассейном на 3 спальни в аренду, в 400 м от пляжа Cha-am с видом на море.", zh: "三卧室泳池别墅出租，距差安海滩400米，可远眺海景。" },
  ...
  },
  {
    ...
    title: { en: "Nong Kae Village Land Plot", th: "ที่ดินหมู่บ้านหนองแก", ru: "Земельный участок Nong Kae", zh: "农凯社区地块" },
    shortDesc: { en: "1,200 sqm of land in a gated Nong Kae village, ready to build.", th: "ที่ดิน 1,200 ตร.ว. ในหมู่บ้านจัดสรรรั้วรอบขอบชิดย่านหนองแก พร้อมปลูกสร้าง", ru: "1200 кв.м земли в закрытом посёлке Nong Kae, готова к застройке.", zh: "1200平方米地块，位于农凯封闭式社区内，具备建屋条件。" },
    fullDesc: { en: "A corner plot within an established gated village near Cha-am's international schools, with utilities connected and covenants allowing single-family homes only.", th: "ที่ดินมุมในหมู่บ้านจัดสรรรั้วรอบขอบชิดที่มั่นคง ใกล้โรงเรียนนานาชาติย่านชะอำ ระบบสาธารณูปโภคพร้อม ข้อบังคับอนุญาตเฉพาะบ้านเดี่ยว", ru: "Угловой участок в устоявшемся закрытом посёлке рядом с международными школами Cha-am, коммуникации подключены, правила разрешают только частные дома.", zh: "位于差安国际学校附近成熟封闭社区内的转角地块，水电已通，规约仅允许建造独立住宅。" },
  ...
  },
  {
    ...
    title: { en: "Cha-am Town Commercial Building", th: "อาคารพาณิชย์ใจกลางชะอำ", ru: "Коммерческое здание в центре Cha-am", zh: "差安市中心商业楼" },
    shortDesc: { en: "A 3-storey commercial building on Cha-am's main road, currently rented to a restaurant tenant.", th: "อาคารพาณิชย์ 3 ชั้น บนถนนสายหลักชะอำ ปัจจุบันปล่อยเช่าให้ผู้เช่าร้านอาหาร", ru: "3-этажное коммерческое здание на главной улице Cha-am, сдано в аренду ресторану.", zh: "位于差安主干道的三层商业楼，目前出租给餐厅租户。" },
...
export const I18N = {
  en: {
    ...
    gallery_photo: "Photo",
    property_overview: "Overview", property_description: "Description", property_features: "Features & Amenities", property_location: "Location", similar_properties: "Similar Properties",
  ...
  th: {
    ...
    property_overview: "ภาพรวม", property_description: "รายละเอียด", property_features: "คุณสมบัติและสิ่งอำนวยความสะดวก", property_location: "ทำเล", similar_properties: "ทรัพย์ใกล้เคียง",
